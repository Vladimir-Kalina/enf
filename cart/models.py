...
from main.models import ProductImageModel, ProductSizeModel, ProductModel
...
class Cart(models.Model):
    ...
    def add_product(self, product, product_size, quantity=1):
        cart_item, created = CartItem.objects.get_or_create(                #TODO!
            cart=self,
            product=product,
...
class CartItem(models.Model):
    ...
    def __str__(self):
        return f"{self.product.name} - {self.product_size.size_name} x {self.quantity}"
